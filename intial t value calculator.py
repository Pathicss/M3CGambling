...
race = input("Enter race (white/hispanic/black/asian): ").strip().lower()
income_value = float(input("Enter household income as a number (e.g., 55000): "))
...
print(f"Tolerance value: {tolerance:.4f}")